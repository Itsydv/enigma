...
def set_bot_credentials(bot_instance: TeleBot):
    ...
    bot_instance.set_my_commands(
        commands=[
            ...
            BotCommand("removewebpagepreview", "Remove webpage preview for a message"),
            BotCommand("removelinks", "Remove hyperlinks from message"),
            BotCommand("addcaption", "Add caption to a media message"),
            BotCommand("removecaption", "Remove caption from a media message"),
            BotCommand("addbutton", "Add buttons to any message"),
            BotCommand("removebuttons", "Remove buttons from a message "),
            ...
            BotCommand("reportbug", "Report a Issue or send message to Admin"),
